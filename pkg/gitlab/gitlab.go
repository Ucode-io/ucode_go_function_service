...
func CommitFiles(cfg IntegrationData, files []*nb.McpProjectFiles) ([]byte, error) {
	if len(files) == 0 {
		return nil, errors.New("no files provided")
	}

	existingFiles, err := GetRepoFilesMap(cfg)
	if err != nil {
...
func GetRepoFilesMap(cfg IntegrationData) (map[string]bool, error) {
