...
func Load() Config {
	...
	config.GithubFrontendSuccessURL = cast.ToString(getOrReturnDefaultValue("GITHUB_FRONTEND_SUCCESS_URL", "https://app.ucode.co"))
	config.GithubFrontendErrorURL = cast.ToString(getOrReturnDefaultValue("GITHUB_FRONTEND_ERROR_URL", "https://app.ucode.co/error"))
