...
func Load() Config {
	...
	config.GitlabRedirectUriIntegration = cast.ToString(getOrReturnDefaultValue("GITLAB_REDIRECT_URI_INTEGRATION", "https://app.ucode.run/main/main/c57eedc3-a954-4262-a0af-376c65b5a280/resources/create"))
