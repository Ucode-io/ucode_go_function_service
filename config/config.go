...
func Load() Config {
	...
	config.GitlabRedirectUriIntegration = cast.ToString(getOrReturnDefaultValue("GITLAB_REDIRECT_URI_INTEGRATION", "http://localhost:7777/main/c57eedc3-a954-4262-a0af-376c65b5a280/resources/create&resource_code=8"))
